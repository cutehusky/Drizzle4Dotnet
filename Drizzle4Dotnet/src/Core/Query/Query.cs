...
public abstract class Query<TDialect>: QueryBase<TDialect>, IAwaitableQuery where TDialect : ISqlDialect
{
...
public abstract class Query<TReturn, TDialect, TVirtualTable>: QueryBase<TDialect>, 
