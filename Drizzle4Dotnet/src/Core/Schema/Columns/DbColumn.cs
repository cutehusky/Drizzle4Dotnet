...
public class DbColumn<T, TTable, TDialect>: IColumnOfTable<TTable, TDialect>, IColumnOfDialect<T, TDialect> where TTable : ITable<TDialect> where TDialect : ISqlDialect
{
