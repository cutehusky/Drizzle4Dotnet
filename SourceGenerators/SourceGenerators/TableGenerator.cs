        ...
        ImmutableArray<TableModel?> tables)
    {
        ...
        foreach (var table in validTables)
        {
            ...
            if (table.TableType == ETableType.Alias)
            {
                ...
                targetModel.Dialect = source.Dialect;
            ...
            if (dialect == null)
            {
                context.ReportDiagnostic(Diagnostic.Create(
                    new DiagnosticDescriptor(
                        "D4D001",
                        "Missing dialect",
                        $"Table '{table.ClassName}' is missing a dialect specification.",
                        "Drizzle4Dotnet.SourceGenerator",
...
");
    ...
    private class TableModel
    {
        ...
        // Dialect
        public DialectInfo? Dialect { get; set; }
    }
}
